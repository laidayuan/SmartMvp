...
public class TextViewUtils {
    ...
    @Nullable
    public static ValueAnimator setMaxLinesWithAnimation(final TextView textView, final int maxLine) {
    ...
    @Nullable
    public static ValueAnimator animatorToHeight(final TextView textView, int h, @Nullable Animator.AnimatorListener listener) {
    ...
    public static int measureTextHeight(TextView textView, CharSequence text) {
    ...
    public static int measureTextHeight(TextView textView, CharSequence text, int maxLines) {
    ...
    public static int measureTextHeight(TextView textView, CharSequence text, TextPaint textPaint, int maxLines) {
