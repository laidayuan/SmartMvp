...
public class BufferedRandomAccessFile extends RandomAccessFile {
    ...
    public long mSeekPos = 0;

    public BufferedRandomAccessFile(String name) throws IOException {
        this(name, "r", DEFAULT_BUFFER_BIT_LEN);
    }

    public BufferedRandomAccessFile(String name, long nStartPos) throws IOException {
        this(name, "r", DEFAULT_BUFFER_BIT_LEN);
        mSeekPos = nStartPos;
    }
    ...
    private int fillbuf() throws IOException {
        super.seek(this.bufstartpos);
        this.bufdirty = false;
        int nRet = super.read(this.buf);

        return nRet;
    }

    public byte readData(long pos) throws IOException {
    ...
    public boolean writeData(byte bw) throws IOException {
        return writeData(bw, this.curpos);
    }

    public boolean append(byte bw) throws IOException {
        return writeData(bw, this.fileendpos + 1);
    }

    public boolean writeData(byte bw, long pos) throws IOException {
    ...
    public int readData(byte b[], int nOff) throws IOException {
        return readData(b, 0, b.length);
    }

    public void seekFile(long pos) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((readcount = brafReadFile.readData(buf)) != -1) {
            brafWriteFile.writeData(buf, 0, readcount);
        }
