...
public class CipherUtils {
    ...
    //微信红包算法
    public static double getRandomMoney(MoneyPackage pack) {
        if (pack.remainSize == 1) {
            pack.remainSize--;
            return Math.floor(pack.remainMoney*100)/100;
        }

        Random r = new Random();
        double min = 0.01;
        double max = pack.remainMoney/pack.remainSize*2;
